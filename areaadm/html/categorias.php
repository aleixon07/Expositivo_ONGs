...
<head>
  ...
  <title>Área administrativa categorias</title>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div id="formContainer" class="fade-in mb-5" style="display: none;">
              ...
              <form action="crud/adicionar_categoria.php" method="POST" class="w-50">
                <div class="col mb-2">
                  <label for="">Nome</label>
                  <input required maxlength="45" type="text" name="nome" class="form-control border border-dark" placeholder="Digite o nome">
                </div>
            ...
            <table class="table border border-2 border-dark w-50">
              ...
              <tbody class="table-light">
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        <button data-bs-toggle="modal" data-bs-target="#modal<?php echo $row["idCategoria"]; ?>" class='btn border border-dark border-opacity-25 rounded'><i class="bi bi-pencil-fill"></i></button>

                        <button onclick='AlertDeletAdm(<?php echo $row["idCategoria"]; ?>)' class='btn rounded border border-dark border-opacity-25'><i class="bi bi-trash-fill"></i></button>
                      </td>
                    </tr>

                    <!-- Modal editar -->
                    <div class="modal fade" id="modal<?php echo $row["idCategoria"]; ?>" tabindex="-1" aria-labelledby="modal
                      ...
                      <div class="modal-dialog ">
                        <div class="modal-content">
                          ...
                          <div class="modal-body border-top border-dark  ">
                            <form action="crud/edit_categoria.php" method="POST">
                              ...
                              <input type="hidden" name="id" id="id" value="<?php echo $row["idCategoria"]; ?>">
                          </div>
    ...
    function AlertDeletAdm(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = `crud/delet_categoria.php?id=${id}`;
        }
      });
    }
  </script>
